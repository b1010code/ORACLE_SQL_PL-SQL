...
-- COUNT Retorna o n�mero de cidades por ano
select a.ano,COUNT(*) qtd_cidades from senso a
group by a.ano
ORDER BY a.ano ASC;


-- Descobrindo qtd estados DISTINCT é utilizado para retornar apenas uma ocorrência de campos que contenham dados repetidos.  
...
-- script 148
-- STDDEV_POP Retorna o desvio padr�o estat�stico para a popula��o de todos os 
...
-- VAR_POP Retorna a vari�ncia estat�stica de todos os valores da express�o especificada
...
-- VAR_SAMP Retorna a vari�ncia estat�stica para o preenchimento 
