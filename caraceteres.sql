...
-- Exemplos com INITCAP( ) coloca primeira letra em maiuscula
select a.DEPARTMENT_NAME nome_depto, 
...
-- Exemplos com LPAD( ) preenchimento de zeros a esquerda
...
-- Exemplos com SUBSTR( ) traz o caractere na posição citada
...
SELECT a.JOB_TITLE,INSTR(a.JOB_TITLE,'r') posicao FROM JOBS a;

SELECT a.JOB_TITLE,INSTR(a.JOB_TITLE,'es') posicao FROM JOBS a;

SELECT a.JOB_TITLE,INSTR(a.JOB_TITLE,'re') posicao FROM JOBS a;

SELECT a.JOB_TITLE,INSTR(a.JOB_TITLE,'t',12) posicao FROM JOBS a;
...
-- Exemplos com DECODE( ) - Fun��es de convers�o 
...
-- Exemplos com REVERSE( ) - Fun��es de convers�o 
